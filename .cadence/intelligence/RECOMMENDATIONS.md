...
## rec-20260807-002 — New undocumented HIGH-severity advisory (js-yaml, GHSA-5p4m-2wfm-xmqj) failing audit; security-success still not registered as a required branch-protection check
...
- decay: fresh
- areas: core, security
- files: docs/security/audit-exceptions.md, .github/workflows/security.yml
- evidence: gh run view (PR #380's audit job) 2026-08-07: 'check-audit-exceptions: FAIL GHSA-5p4m-2wfm-xmqj (js-yaml, high) -- not listed in docs/security/audit-exceptions.md'. gh api repos/thomas-powers-jr/cadence/branches/main/protection --jq '.required_status_checks.contexts' returned exactly ["ci-success"] -- security-success/codeql-success absent.
- next: cadence milestone propose
