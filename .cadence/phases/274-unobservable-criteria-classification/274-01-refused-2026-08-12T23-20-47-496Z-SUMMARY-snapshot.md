...
**Completed:** 2026-08-12T23:20:47.496Z
**Content hash (sha256):** 697703b5794dfedb62037a2f46fb2b573f1c9d42e98e24a2e29973ceb0695383
...
- MEDIUM: During verifier failure, direct classification only skips the floor. The saved AC still gets `evidence: 'unverified'` and is counted in assurance, violating off-ladder semantics. (line 1127) [id: 97f3a755c3e5972ac2837a9c020df533530fa3a27c30cf0c77acae6708324063; target: artifact; anchor: kind=ac, ref=AC-4, tier=executable; disposition: open]

#### packages/core/src/verify/criteria-observability.ts

- HIGH: `SUMMARY_TOKEN` matches bare `SUMMARY` before any extension, so `SUMMARY.mdx`/`.yaml` are marked unobservable. That can suppress a real deep-verify failure. (line 90) [id: 31ad158a975c44df2489563cf8ccc896a6b5a75699eda8bde834fefe378e7354; target: artifact; anchor: kind=ac, ref=AC-1, tier=executable; disposition: open]

#### packages/types/src/summary.ts

- MEDIUM: The documented presence-only marker accepts `false`. A persisted `unobservable: false` is silently treated as observable; use `z.literal(true).optional()`. (line 23) [id: 7098804935084dc159844ffee3e90fe57e8a5e8635de0cd6ca3771fae297ff31; target: artifact; anchor: kind=ac, ref=AC-1, tier=executable; disposition: open]
