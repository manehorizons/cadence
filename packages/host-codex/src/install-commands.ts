...
const COMMANDS: CommandSpec[] = [
  ...
  { name: 'cadence-build', description: 'Record outcome of a build task', argumentHint: '<task-id> --status=<DONE|DONE_WITH_CONCERNS|NEEDS_CONTEXT|BLOCKED>', cli: 'build task $ARGUMENTS', trailing: 'Continue with the next task or run /cadence-settle when done.' },
